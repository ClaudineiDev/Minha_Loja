...
public class Venda extends RealmObject {
    ...
    public Venda(long id, long id_v, String id_item_v, String tipo_v, long id_cliente_v, String descricao_v,
    ...
    public long getId_cliente_v() {
        return id_cliente_v;
    }

    public void setId_cliente_v(long id_cliente_v) {
        this.id_cliente_v = id_cliente_v;
    }
